          ...
          <div className="space-y-6">
            ...
            <div className="bg-orange-50 dark:bg-orange-950/20 p-6 rounded-lg border border-orange-200 dark:border-orange-800">
              ...
              <p className="text-sm text-orange-800 dark:text-orange-200">
                Die Baugenehmigungsbehörde für Schieder-Schwalenberg ist beim Kreis Lippe angesiedelt. 
            ...
            <div className="pt-6 border-t">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                ...
                <p>Öffnungszeiten: Mo-Fr: 8:00-12:00 Uhr, Do: 14:00-17:00 Uhr</p>
              </div>
            </div>
            ...
            <div className="pt-6 border-t">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Für allgemeine Fragen zum Bauen in Schieder-Schwalenberg können Sie sich auch 
                an das Bauamt der Stadt wenden:
              </p>
              <div className="space-y-2 text-sm text-muted-foreground">
                <p>Telefon: 05282 / 601-0</p>
                <p>E-Mail: bauamt@schieder-schwalenberg.de</p>
              </div>
            </div>
          </div>
        </Card>
